...
export const showcases: AIShowcase[] = [
  {
    slug: 'tami-gadi',
    title: 'החתונה של תמי וגדי — סיפור אהבה שהתחיל בהודו',
    badge: 'פתיח AI',
    description: 'מפגש מקרי בהודו בין מי שחיפשה שלווה למי שחיפש הזדמנות — סרטון AI שמספר איך זה הפך לאהבה ולחתונה.',
    thumbnail: 'https://pub-0fce3727bd4b426f910073f9e5070a72.r2.dev/ai%20videos/Love%20story%20India-web.mp4',
    thumbnailIsVideo: true,
    featured: true,
    hasSound: true,
    type: 'single-video-wide',
    mainVideo: 'https://pub-0fce3727bd4b426f910073f9e5070a72.r2.dev/ai%20videos/Love%20story%20India-web.mp4',
    videoCaption: '🎬 סיפור אהבה שנבנה עם AI',
    tags: ['פתיח קולנועי', 'סיפור אהבה', 'חתונה'],
    detailsPanel: [
      {
        heading: 'על הסרטון',
        body: 'תמי טסה להודו כדי למצוא שקט — גדי הגיע לשם בשביל הזדמנויות נדל״ן. שניהם לא תכננו למצוא אחד את השני, אבל מפגש מקרי אחד הצית חיבור שאי אפשר היה להתעלם ממנו. בנינו סרטון AI שלוקח את הרגע הזה — הצבעים, האנרגיה והקסם של הודו — והופך את סיפור ההיכרות שלהם לפתיח קולנועי שמוביל עד לחופה.',
      },
      {
        heading: 'מה מיוחד בסרטון הזה',
        body: 'במקום להראות רק תמונות, נתנו לסיפור לקום לחיים — עם AI שמשחזר את האווירה של הודו ואת המסע של שניהם מזרים אחד עד לאהבה אחת. זה לא רקע לחתונה — זה הפתיח שמכניס את כל האורחים לתוך הסיפור עוד לפני שהזוג נכנס.',
      },
    ],
  },
  {
    ...
    hasSound: true,
    type: 'single-video-wide',
    mainVideo: 'https://pub-0fce3727bd4b426f910073f9e5070a72.r2.dev/ai%20videos/Ami%27s%20Bat%20Mitzvah%20Party%20-%20small.mp4',
    videoCaption: '🎬 סרט שלם שנבנה כולו בבינה מלאכותית',
    tags: ['סרט מלא', 'בת מצווה', 'מותאם אישית'],
    detailsPanel: [
      {
        heading: 'על הסרט',
        body: 'יום אחד בחייה של ילדה בת 12, מהרגע שהכלב מעיר אותה בבוקר ועד הריקוד האחרון בערב. הים והגלישה, אחר הצהריים עם אמא בקניון, החזרה בסטודיו המחול, והדלת של האולם שנפתחת. כל פריים בסרט הזה נוצר בבינה מלאכותית — אין כאן צילום אמיתי אחד.',
      },
      {
        heading: 'גם לכם יכול להיות סרט כזה',
        body: 'סרט כזה נבנה לפי מידה, מתסריט מקורי שנכתב עבורכם — לא מתבנית מוכנה. מתחילים בשאלון קצר ובשיחה: מי הילד או הילדה, מה אוהבים, אילו דמויות חייבות להיות בפנים, ואילו רגעים המשפחה לא תסלח לנו אם נשכח. מכאן אנחנו בונים את הסיפור, וממשיכים יחד אתכם לאורך כל הדרך עד שהתוצאה מדויקת ומרשימה. חשוב לדעת מראש: התהליך ארוך יותר מהכנה של מצגת רגילה — סרט כזה נבנה שלב אחרי שלב, ולוקח את הזמן שלו.',
      },
    ],
  },
  {
    slug: 'adam-race',
    title: 'המרוץ של אדם — סרט בר מצווה בהשראת סרטי פעולה',
    badge: 'סרט AI מלא',
    description: 'שעון שרץ, גג אחרי גג, ומרוץ אחד נגד הזמן — סרט בר מצווה בקצב של סרט פעולה. סרט כזה יכול להיבנות גם עבורכם.',
    thumbnail: 'https://pub-0fce3727bd4b426f910073f9e5070a72.r2.dev/ai%20videos/Adam%20race%20final-hero.mp4',
    thumbnailIsVideo: true,
    featured: true,
    hasSound: true,
    type: 'single-video-wide',
    mainVideo: 'https://pub-0fce3727bd4b426f910073f9e5070a72.r2.dev/ai%20videos/Adam%20race%20final-hero.mp4',
    videoCaption: '🎬 סרט שלם שנבנה כולו בבינה מלאכותית',
    tags: ['סרט מלא', 'בר מצווה', 'סרט פעולה'],
    detailsPanel: [
      {
        heading: 'על הסרט',
        body: 'שעון רץ בפינת המסך, ולאדם יש יעד אחד — להגיע בזמן. הסרט נפתח בחדר שלו בבוקר ולא עוצר מרגע זה: קפיצה מגג לגג מעל העיר, משחק כדורסל מול יציע רועש, ריצה במעלה הגבעה בין שתי שורות של אנשים שמריעים לו בשקיעה, ועד למסיבה בערב. הכל בנוי בקצב, בחיתוכים ובמתח של סרט פעולה — רק שהגיבור הוא ילד בן 13, והיעד הוא הטקס שלו. כל פריים בסרט הזה נוצר בבינה מלאכותית.',
      },
      {
        heading: 'גם לכם יכול להיות סרט כזה',
        body: 'גם סרט כזה נבנה לפי מידה, מתסריט מקורי שנכתב סביב הילד שלכם — לא מתבנית מוכנה. מתחילים בשאלון קצר ובשיחה: מה מלהיב אותו, במה הוא הכי טוב, ואילו רגעים חייבים להיות שם. מכאן אנחנו בונים את הסיפור, וממשיכים יחד אתכם לאורך כל הדרך עד שהתוצאה מדויקת ומרשימה. חשוב לדעת מראש: התהליך ארוך יותר מהכנה של מצגת רגילה — סרט כזה נבנה שלב אחרי שלב, ולוקח את הזמן שלו.',
      },
    ],
  },
  {
