...
export const showcases: AIShowcase[] = [
  {
    ...
    badge: 'וידאו AI',
    description: 'הנוף מתחיל לזוז, הגלים חיים — זה מה שנוצר מתמונה אחת שהלקוח שלח. יש לכם תמונה מטיול? אנחנו יכולים לעשות בדיוק כזה.',
  ...
  },
  {
    ...
    badge: 'וידאו AI',
    description: '6 תמונות מגילאים שונים — ו-AI שיצר סרטון מעבר קסום שגרם לכולם לבכות. מושלם לפתיחת מצגת בת מצווה.',
  ...
  },
  {
    ...
    badge: 'תמונות AI',
    description: 'מתמונה אחת — שלושה עולמות דמיוניים שגרמו לכל האולם לצחוק. יודעים כבר מה עושה הגיבור שלכם אחרי הפרישה?',
  ...
  },
  {
    ...
    description: 'מ-6 תמונות נפרדות — AI יצר סלפי קבוצתי שהפך לסרטון חי. הכוכב שלכם מעריץ מישהו? אנחנו יכולים לשים אותו לידו.',
  ...
  },
  {
    ...
    badge: 'תמונות AI',
    description: 'מתמונה אחת — AI שילב את הילדה בסטים של הסרטים האהובים עליה. איזה סרט או עולם הילד שלכם הכי אוהב?',
  ...
  },
  {
    ...
    badge: 'וידאו AI',
    description: 'נער יושב על ספסל בתל אביב — AI הפך אותו לסיטואציה מפתיעה בפריז. שלחו לנו תמונה — נשלח אתכם לכל מקום בעולם.',
  ...
  },
  {
    ...
    badge: 'תמונות + וידאו AI',
    description: 'מ-3 תמונות נפרדות — AI יצר סלפי שגרם לכולם לצרוח מרוב התרגשות. מי הזמר או הזמרת שהילדה שלכם הכי מעריצה?',
  ...
  },
  {
    ...
    badge: 'וידאו AI',
    hasSound: true,
    description: 'רונלדו אומר "מזל טוב לשגיא" — האולם פוצץ. רוצים ברכה מהכוכב האהוב? שלחו לנו שם.',
  ...
  },
  {
    ...
    badge: 'וידאו AI',
    description: 'מגדל פיזה, החומה הסינית, לונדון, ניו יורק — מתמונה אחת. לאיפה הפורש שלכם תמיד חלם לנסוע?',
